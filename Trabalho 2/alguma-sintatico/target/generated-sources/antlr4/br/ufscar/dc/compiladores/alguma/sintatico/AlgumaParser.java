...
public class AlgumaParser extends Parser {
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 37044092952L) != 0) {
				{
				{
				setState(105);
				decl_local_global();
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(175);
			_la = _input.LA(1);
			if ( !((((_la - 6)) & ~0x3f) == 0 && ((1L << (_la - 6)) & 396316767208603651L) != 0) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case PROCEDIMENTO:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 34359738392L) != 0) {
					{
					{
					setState(215);
					declaracao_local();
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & -8935141497441599488L) != 0) {
					{
					{
					setState(221);
					cmd();
